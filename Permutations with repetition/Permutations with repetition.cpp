...
/*
Написать программу, которая  генерирует слова, содержащие k букв (от «а» до «о»),
допускающие повторения букв, но никакая буква не должна встречаться более k-2 раз.*/
